...
namespace ChaosPoppycarsCards.Patches
{
    ...
    class HealtHandlerPatchTakeDamage
    {
        private static void SimGun(Player player, Vector2 damage)
        {
            ...
            DmgBullet.damage = damage.magnitude / 110f;
        ...
        private static void Prefix(HealthHandler __instance, Vector2 damage, Vector2 position, GameObject damagingWeapon, Player damagingPlayer, bool lethal)
        {
