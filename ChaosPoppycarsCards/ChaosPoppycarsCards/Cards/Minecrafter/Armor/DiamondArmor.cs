...
namespace ChaosPoppycarsCards.Cards.Minecrafter
{
    class Darmor : CustomCard
    {
        ...
        {
            ModdingUtils.Extensions.CharacterStatModifiersExtension.GetAdditionalData(player.data.stats).blacklistedCategories.Remove(CPCCardCategories.DiamondArmorCategory);
        ...
        {
            return "Put on diamond armor to survive longer, unlocks netherite armor";
        }
        protected override GameObject GetCardArt()
        {
            return ChaosPoppycarsCards.Bundle.LoadAsset<GameObject>("C_DiamondArmor");
        }
