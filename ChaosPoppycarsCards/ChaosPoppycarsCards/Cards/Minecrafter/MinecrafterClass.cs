...
namespace ChaosPoppycarsCards.Cards.Minecrafter
{
    class MinecrafterClass : ClassHandler
    {
        ...
        public override IEnumerator Init()
        {
            ...
            ClassesRegistry.Register(WoodenSword.Card, CardType.SubClass, CraftingTable.Card);
            ...
            ClassesRegistry.Register(WoodenAxe.Card, CardType.SubClass, CraftingTable.Card);
            ...
            ClassesRegistry.Register(AttackSpeed.Card, CardType.SubClass, CraftingTable.Card);
            ...
            ClassesRegistry.Register(Larmor.Card, CardType.SubClass, CraftingTable.Card);
