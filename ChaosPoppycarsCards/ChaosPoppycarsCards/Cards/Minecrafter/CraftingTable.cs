...
{
    class CraftingTable : CustomCard
    {
        ...
        {
            return "Become one with the minecraft world, unlocks minecraft cards";
        }
        protected override GameObject GetCardArt()
        {
            return ChaosPoppycarsCards.Bundle.LoadAsset<GameObject>("C_CraftingTable");
        }
