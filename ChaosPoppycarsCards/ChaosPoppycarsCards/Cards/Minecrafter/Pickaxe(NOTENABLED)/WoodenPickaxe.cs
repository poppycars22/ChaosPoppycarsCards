...
{
	internal class WoodenPickaxe : CustomCard
	{
		public override void SetupCard(CardInfo cardInfo, Gun gun, ApplyCardStats cardStats, CharacterStatModifiers statModifiers, Block block)
		{
			gun.objectsToSpawn = new ObjectsToSpawn[]
			{
				new ObjectsToSpawn
				{
					effect = WoodenPickaxe.drill,
					spawnAsChild = true,
					spawnOn = ObjectsToSpawn.SpawnOn.notPlayer
				}
			};
			gun.attackSpeed = 6f;
            gun.projectielSimulatonSpeed = 0.05f;
            gun.reloadTime = 6f;
            gun.spread = 0.5f;
			gun.damage = 0.5f;
        }
		...
		{
			return "Your bullets mine away the ground they touch <b><color=#ffd900>MAY BE UNSTABLE, USE AT YOUR OWN RISK</color></b> (on hit effect made by Tess)";
		}
