...
namespace ChaosPoppycarsCards
{
    ...
    public class ChaosPoppycarsCards : BaseUnityPlugin
    {
        ...
        public const string Version = "0.8.1"; // What version are we on (major.minor.patch)?
        ...
        void Awake()
        {
            ...
            RarityUtils.AddRarity("Goose", 12, new Color(0.722f, 0.840f, 0.775f), new Color(0.860f, 1.00f, 0.923f));
...

        {
            ...
            CustomCard.BuildCard<ScarceJackpot>();
